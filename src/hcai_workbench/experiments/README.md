...
This is a series of experiments I found and played around with while building this app, and I decided to include them in case anybody else is interested.
...
```bash
python3 -m hcai_workbench.experiments.{experiment}
```
